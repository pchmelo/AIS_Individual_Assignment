...
class SensitiveDetectionStage(BaseStageExecutor):
    ...
    def __call__(self, stage, ctx: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = (
            ...
            "For EACH sensitive column, output EXACTLY this format (NO bold markers **):\n"
            "1. Column: ColumnName | Reason: description | Values: [val1, val2, val3]\n"
            "2. Column: ColumnName | Reason: description | Values: [val1, val2, val3]\n\n"
            "FORMATTING RULES:\n"
            "- Use numbered list (1. 2. 3.) for each column\n"
            "- Do NOT use ** bold markers ** around Column:\n"
            "- Keep text plain without markdown formatting\n"
